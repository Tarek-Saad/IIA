...
class LearnerMapper:
    ...
    def to_dict(self):
        return {
            ...
            "learning_style_active_reflective": self.learning_style_active_reflective,
            "learning_style_visual_verbal": self.learning_style_visual_verbal,
            "learning_style_sensing_intuitive": self.learning_style_sensing_intuitive,
            "learning_style_sequential_global": self.learning_style_sequential_global,
